...
class NaverBookRepositoryTest extends Specification {
    ...
    def "search호출시 적절한 데이터 형식으로 변환한다."() {
        given:

        def items = [
                new Item(title: "제목1", author: "저자1", publisher: "출판사1", pubDate: "20240322", isbn: "9788966261208"),
                new Item(title: "제목2", author: "저자2", publisher: "출판사2", pubDate: "20240322", isbn: "9788966261208")
        ]

        def response = new NaverBookResponse(
                lastBuildDate: "Sun, 22 Mar 2026 10:40:33 +0900",
                total: 2,
                start: 1,
                display: 2,
                items: items
        ...
        verifyAll {
            ...
            result.contents().get(0).pubDate() == LocalDate.of(2024, 3, 22)
        }
    }
