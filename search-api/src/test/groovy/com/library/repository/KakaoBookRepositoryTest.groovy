...
class KakaoBookRepositoryTest extends Specification {
    ...
    def "search호출시 적절한 데이터 형식으로 변환한다."() {
        ...
        def documents = [
                new Document("제목1", ["저자1"], "출판사1", "isbn1", "2021-01-01T00:00:00.000+09:00"),
                new Document("제목2", ["저자2"], "출판사2", "isbn2", "2021-01-01T00:00:00.000+09:00")
        ]
        ...
        verifyAll(result) {
            ...
            totalElements() == 10
            contents().size() == 2
            contents().get(0).pubDate() == LocalDate.of(2021, 1, 1)
        }
    }
