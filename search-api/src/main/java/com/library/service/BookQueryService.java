...
public class BookQueryService {
    ...
    @CircuitBreaker(name = "naverSearch", fallbackMethod = "fallbackSearch")
    public PageResult<SearchResponse> search(String query, int page, int size) {
        return naverBookRepository.search(query, page, size);
    }

    public PageResult<SearchResponse> fallbackSearch(String query, int page, int size, Throwable throwable) {
    ...
    private PageResult<SearchResponse> handleOpenCircuit(String query, int page, int size) {
        log.warn("[BookQueryService] Circuit is open!. Fallback to kakao Search");
    ...
    private PageResult<SearchResponse> handleException(String query, int page, int size, Throwable throwable) {
        log.error("[BookQueryService] An error occurred! during search. Fallback to kakao Search. errorMessage={}", throwable.getMessage());
        return kakaoBookRepository.search(query, page, size);
    }
